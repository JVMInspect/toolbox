...
class KlassDumper(
    ...
    fun writeLocalVariableTypeTableAttribute(method: Method, localVariableTypeTableLength: Int) {
    ...
    fun writeLocalVariableTableAttribute(method: Method, localVariableTableLength: Int) {
    ...
    fun writeStackMapTableAttribute(method: Method, stackMapLength: Int) {
